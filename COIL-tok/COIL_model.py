...
class COIL_tok_Model(nn.Layer):
    def __init__(self, pretrained_model_name='bert-base-uncased', model_name="COIL-tok", nt=32):
        super(COIL_tok_Model, self).__init__()
